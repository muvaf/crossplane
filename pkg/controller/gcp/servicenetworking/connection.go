...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (resource.ExternalObservation, error) {
	...
	observed := findConnection(r.Connections)
	if observed == nil {
	...
	eo := resource.ExternalObservation{
		ResourceExists:   true,
		ResourceUpToDate: connection.UpToDate(cn.Spec.ConnectionParameters, observed),
	}

	connection.UpdateStatus(&cn.Status, observed)
